...
$url = "../GlycoSample/GlycoSample-json-table.php?id=".$GSID;
...
echo '<h3><a href="'.$url.'" target="_blank" >Link to GlycoSample Data (GlycoNAVI:'.$GSID.')</a></h3>';
...
printf("<div>");
printf("<iframe id=\"protein-name-iframe\" class=\"proteinNameFrame\" src=\"".$url."\" width=\"1300\" height=\"200\"></iframe>");
printf("</div>");
...
printf("<div>");
printf("<iframe id=\"protein-iframe\" class=\"proteinFrame\" src=\"".$url."\" width=\"1300\" height=\"200\"></iframe>");
printf("</div>");
printf("<SCRIPT>jQuery('iframe.proteinFrame').iframeAutoHeight();</SCRIPT>");
